...
INSERT INTO `AD_report_decision_tree_method` (`ad_report_id`, `method`, `model_accuracy_score_with_criterion_gini_index`, `training_set_accuracy_score`, `training_set_score`, `test_set_score`, `precision`, `recall`, `f1_score`, `general_score`)
